...
namespace vikaro_angular.Controllers
{
    public class SupplierController : ApiController
    {
        ...
        {
            return db.Businesses.Where(a => a.BusinessType.Equals("supplier"));
        }
        ...
        public async Task<IHttpActionResult> GetBusiness(int id)
        {
            ...
            Business business = await db.Businesses.Where(a => a.BusinessType.Equals("supplier")).SingleOrDefaultAsync(a => a.Id == id);
            if (business == null)
            {
                return NotFound();
            }
